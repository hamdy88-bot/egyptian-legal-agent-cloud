...
question: str = Field(..., min_length=3, description="السؤال أو المهمة القانونية")
context: Optional[str] = Field(None, description="وقائع أو سياق إضافي")
mode: str = Field(
"safe",
description="safe أو research أو reverse أو drafting أو closure",
)
...
route = mode_to_route.get(mode_to_route and task.mode, mode_to_route["safe"])
...
return {
    ...
    "agent_route": route,
    "message": (
        "تم استقبال المهمة وتحديد مسار الوكلاء. "
        "هذه النواة لا تحتوي بعد على نموذج ذكاء اصطناعي أو قاعدة معرفة قانونية؛ "
